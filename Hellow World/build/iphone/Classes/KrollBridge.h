...
@interface HellowWorldObject : KrollCoverageObject {
#else
@interface HellowWorldObject : KrollObject {
#endif
@private
...
extern NSString * HellowWorld$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HellowWorldObject *_hellowworld;
    KrollObject* console;
	BOOL shutdown;

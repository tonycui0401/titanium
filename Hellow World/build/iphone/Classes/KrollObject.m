...
//@interface HellowWorldObject : NSObject
//@end

@interface HellowWorldObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HellowWorldObject class]])
		{
			for (NSString *key in [[(HellowWorldObject*)o modules] allKeys])
			{

...
/**
 Base class for all HellowWorld views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HellowWorld view hierarchy (such as wrapped iOS UIViews) was touched.

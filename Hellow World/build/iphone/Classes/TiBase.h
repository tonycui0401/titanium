...
// in simulator we redefine to format for HellowWorld Developer console
...
{\
	NSString * exceptionName = [@"org.hellowworld." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hellowworld";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHellowWorldNativeItemNone = -1, 
	UIHellowWorldNativeItemSpinner = -2,
	UIHellowWorldNativeItemProgressBar = -3,
	
	UIHellowWorldNativeItemSlider = -4,
	UIHellowWorldNativeItemSwitch = -5,
	UIHellowWorldNativeItemMultiButton = -6,
	UIHellowWorldNativeItemSegmented = -7,
	
	UIHellowWorldNativeItemTextView = -8,
	UIHellowWorldNativeItemTextField = -9,
	UIHellowWorldNativeItemSearchBar = -10,
	
	UIHellowWorldNativeItemPicker = -11,
	UIHellowWorldNativeItemDatePicker = -12,
	
	UIHellowWorldNativeItemInfoLight = -13,
	UIHellowWorldNativeItemInfoDark = -14,
	
	UIHellowWorldNativeItemDisclosure = -15,
	
	UIHellowWorldNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HellowWorld instances of
